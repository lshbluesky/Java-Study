...
public class BookManager {
	// private TreeSet<Book> bookSet = new TreeSet<Book>();

	private TreeSet<Book> bookSet = new TreeSet<Book>(new Comparator<Book>() {
	...
	public void updateBook(String title, String author, int price) {
		for (Book b : bookSet) {
			if (b.getTitle().equals(title)) {
				...
				b.setAuthor(author);
				b.setPrice(price);
				System.out.println("※ 수정 후 : " + b + " 으로 도서 정보가 수정되었습니다.");
				return;
			}
		}
